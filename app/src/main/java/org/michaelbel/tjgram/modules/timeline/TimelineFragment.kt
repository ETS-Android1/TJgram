...
import org.michaelbel.tjgram.modules.timeline.adapter.EntriesAdapter
import org.michaelbel.tjgram.modules.timeline.adapter.EntriesListener
import org.michaelbel.tjgram.modules.addpost.decoration.PhotoSpacingDecoration
import org.michaelbel.tjgram.modules.timeline.decoration.EntrySpacingDecoration
...
class TimelineFragment : Fragment(), TimelineContract.View, EntriesListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private val presenter: TimelineContract.Presenter by inject()
