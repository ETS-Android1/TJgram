...
import org.michaelbel.tjgram.ui.newphoto.NewEntryContract
import org.michaelbel.tjgram.ui.newphoto.NewEntryPresenter
import org.michaelbel.tjgram.ui.newphoto.NewEntryRepository
...
val appModule = module {
    ...
    factory<NewEntryContract.Presenter> { NewEntryPresenter(NewEntryRepository(createService(androidContext()))) }
}