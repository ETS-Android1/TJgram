...
public class ExpandableView extends LinearLayout {
    ...
    private LinearLayoutCompat innerView;
    ...
    protected void onFinishInflate() {
        ...
        arrowIcon.setImageDrawable(ViewUtil.INSTANCE.getIcon(getContext(), R.drawable.ic_chevron_down, R.color.icon_active));
    ...
    private void setInnerView(int resId){
        ...
        innerView = (LinearLayoutCompat) stub.inflate();
    }
    ...
    public void addChildView(SocialView view) {
