package org.michaelbel.tjgram.ui.common.gestures;
...
public class GestureImageView extends AppCompatImageView implements GestureView, ClipView, ClipBounds, AnimatorView {
    ...
    @Deprecated
    public void getSnapshot(com.alexvasilkov.gestures.views.GestureImageView.OnSnapshotLoadedListener listener) {
        if (getDrawable() != null) {
