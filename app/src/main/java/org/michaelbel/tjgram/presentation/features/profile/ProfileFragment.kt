...
class ProfileFragment : Fragment(), ProfileContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //viewModelFactory = Injection.provideMainViewModelFactory(requireContext())
        //userViewModel = ViewModelProviders.of(this, Injection.provideViewModelFactory(requireContext())).get(UserViewModel::class.java)

        /*profileViewModel = ViewModelProviders.of(this, factory).get(ProfileViewModel::class.java)
        profileViewModel.viewState.observe(this, Observer {

        })
        profileViewModel.errorState.observe(this, Observer {
    ...
    private fun setFragmentUI() {
        if (UserConfig.isAuthorized(requireContext())) {
            ...
            // todo add to strings
            mainViewModel.setToolbarTitle("Войти")
        } else {
            profileLayout.visibility = GONE
            authLayout.visibility = VISIBLE
            mainViewModel.setToolbarTitle(getString(R.string.profile))
        }
    }
    ...
    private fun setProfile() {
        ...
        /*disposable.add(userViewModel.localUser(userId).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
            .subscribe({
    ...
    private fun addUserToRoom(user: User) {
        ...
        /*disposable.add(
            userViewModel.updateUser(user).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
    ...
    override fun onDestroy() {
        super.onDestroy()
        presenter.destroy()
        App[requireActivity().application].removeProfileComponent()
    }
}